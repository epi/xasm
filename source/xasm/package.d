...
class Xasm {
	...
	static immutable TITLE = "xasm 3.1.0";
	...
	alias MoveFunction = void delegate(int move);
	...
	unittest {
		...
		auto xasm = new Xasm;
		assert(xasm.testInstruction("nop") == x"ea".representation);
		assert(xasm.testInstruction("add (5,0)") == x"18a2006105".representation);
		assert(xasm.testInstruction("mwa #$abcd $1234") == x"a9cd8d3412a9ab8d3512".representation);
		assert(xasm.testInstruction("dta 5,d'Foo'*,a($4589)") == x"05a6efef8945".representation);
